...
const API_KEY = "api_key=fc46f1ca7acbf330c3350445a3c2d686";
const SEARCH_URL = "search/movie?langue=fr&include_adult=false"
...
class App extends Component {
  ...
  applyVideoToCurrentMovie() {
    axios
      .get(`${API_END_POINT}movie/${this.state.currentMovie.id}?append_to_response=videos&include_adulte=false&${API_KEY}`)
      .then(
        function(response) {
